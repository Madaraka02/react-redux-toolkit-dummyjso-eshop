export const MAIN_HOMEPAGE = '/'
export const PRODUCT_POSTFIX = 'productId'
export const SEARCH_TERM = 'searchName'
export const SEARCH_PREFIX = '/product/search'
...
export const CATEGORY_PRODUCTS_PAGE = `/${CATEGORY_PREFIX}:${CATEGORY_POSTFIX}`
