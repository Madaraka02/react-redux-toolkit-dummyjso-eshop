...
import { useGetCategoryProductsQuery } from '../features/products/productsApiSlice'

function CategoryProducts() {
    const  { categoryName } = useParams()

    const { data: products, isLoading, isSuccess, isError, error } = useGetCategoryProductsQuery(categoryName)
